...
function Header() {
  ...
  return (
    <header className="bg-purple-100 p-4">
      ...
      {/* Mobile Menu */}
      <div className={`md:hidden mb-4 flex flex-col items-center space-y-4 mt-4 transition-all duration-300 ease-in-out ${isMenuOpen ? 'max-h-60 opacity-100' : 'max-h-0 opacity-0 overflow-hidden'}`}>
